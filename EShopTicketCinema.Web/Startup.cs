using EShopTicketCinema.Domain;
using EShopTicketCinema.Repository.Implementation;
using EShopTicketCinema.Repository.Interface;
using EShopTicketCinema.Repository;
using EShopTicketCinema.Services.Implementation;
using EShopTicketCinema.Services.Interface;
using EShopTicketCinema.Web.Data;
...
namespace EShopTicketCinema.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<TicketCinemaUser>(options => options.SignIn.RequireConfirmedAccount = true)
